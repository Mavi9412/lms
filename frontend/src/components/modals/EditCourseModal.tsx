...
const EditCourseModal = ({ course, onClose, onSuccess }: EditCourseModalProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await api.patch(`/admin/courses/${course.id}`, data);
            onSuccess();
            onClose();
        } catch (error: any) {
    ...
    return (
        ...
        >
            <div
                className="bg-[#0f172a] rounded-xl border border-white/10 max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl"
