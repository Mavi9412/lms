...
export default function CreateAnnouncementModal({ isOpen, onClose, courseId, onCreated }: CreateAnnouncementModalProps) {
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Please be informed that..."
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <input
                            ...
                            className="w-4 h-4 text-teal-500 border-gray-600 rounded focus:ring-teal-500"
                        />
